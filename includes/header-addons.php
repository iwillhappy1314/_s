...
class Footer_Addons {
	...
	public function load_actions() {
		require_once WENPRISE_INCLUDES_PATH . 'header-addons/hooks.php'; // phpcs:ignore WPThemeReview.CoreFunctionality.FileInclude.FileIncludeFound
	}
	/**
	...
	public function locate_header_template( $template_name ) {
		...
		$default_path  = WENPRISE_INCLUDES_PATH . 'header-addons/templates/';
	...
	public function create_pro_settings_array( $wp_customize ) {
		...
		foreach ( self::$settings_sections as $key ) {
			require_once WENPRISE_INCLUDES_PATH . 'header-addons/' . $key . '-options.php'; // phpcs:ignore WPThemeReview.CoreFunctionality.FileInclude.FileIncludeFound
		}
	}
}

Footer_Addons::get_instance();
